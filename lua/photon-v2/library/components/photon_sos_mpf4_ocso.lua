...
COMPONENT.Name = "photon_sos_mpf4_ocso"
...
COMPONENT.Title = [[SoundOff Signal mpower Fascia 4 Oshiumi"]]
...
COMPONENT.Segments = {
	Light = {
		...
		Sequences = {
			...
			["QUAD"] = sequence():FlashHold( 1, 1, 0, 1, 1, 0, 1, 1, 0, 1, 1 ),
			["OFF"] = { 0 },
		}
	},
...
COMPONENT.Name = "photon_sos_mpf4_bracket_x2_ocso"
...
-- photon_s[ound]o[ff]s[ignal]_mp[ower]f[ascia]4[inch]lic[ense plate]_h[orizontal]
COMPONENT.Title = [[SoundOff Signal mpower Fascia 4 Oshiumi" (Bracket x2)]]
COMPONENT.Category = "Perimeter"
...
COMPONENT.Name = "photon_sos_mpf4_x4_ocso"
...
-- photon_s[ound]o[ff]s[ignal]_mp[ower]f[ascia]4[inch]lic[ense plate]_h[orizontal]
COMPONENT.Title = [[SoundOff Signal mpower Fascia 4 Oshiumi" (x4)]]
COMPONENT.Category = "Perimeter"
